...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["AjaxValider"])) {
    ...
    // get Respo
    $users = $db->Select('compte', 'user', "compteType = 'stagiaire'");
    $list = array();
        ...
        $(document).ready(function () {
            ...
            $(".switcher").on('change', function () {
                if ($(this).is(':checked')) {
                    ...
                    if (CEF) {
                        $.get({
                            url: './inc/Ajax/DeleteStagiaire.php',
                            data: { CEF: CEF },
                            success: function (data) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-5 static-top shadow">
                    <h4 class="mr-auto ml-md-3 my-2 my-md-0 mw-100 font-weight-bold">Liste des stagiaires</h4>
                    <a href="./logout.php" id="Déconnexion">
                        <i class="fas fa-sign-out-alt fa-lg fa-fw mr-2 text-gray-700"></i>
                    </a>
                </nav>
                <!-- End of Topbar -->
                <!-- Begin Page Content -->
                                ...
                                <div class="container ">
                                    <div class="row ">
                                        <div class="col-sm-12 col-md-6 p-0">
                                            <dt class="m-0 font-weight-bold text-primary" class="titre">Groupe :
                                                <?= $grpname ?>
                                            </dt>
                                        </div>
                                        <div class="col-sm-12 col-md-6 text-right mb-2 p-0">
                                            <a href="./AjouterStagiaire.php?idgrp=<?= $_SESSION["groupe"] ?>"><input
                                                    class="btn btn-primary btn-sm" type="submit"
                                                    value="Ajouter un stagiaire" id="addStg" /></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Stagiaires as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if (in_array($value->CEF, $list)) {
                                                            ?>
                                                            <div class="form-check form-switch">
                                                                <input value="<?= $value->CEF ?>" class="form-check-input respo"
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch">
                                                            <input value="<?= $value->CEF ?>" class="form-check-input switcher"
                                                                type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                                            <label class="form-check-label"
                                                                for="flexSwitchCheckDefault"></label>
                                                        </div>
