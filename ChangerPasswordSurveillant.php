        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-5 static-top shadow">
                    ...
                    <h5 class="mr-auto ml-md-3 my-2 my-md-0 mw-100 font-weight-bold">Changer le mot de passe</h5>
                        ...
                        <div class="card shadow py-5 w-50 d-flex justify-content-center align-items-center w-50 p-4 mt-7 "
                            ...
                            <div>
                                ...
                                <div class="form-group mt-6">
                                    <div class="form-row">
                                        <label class="col-md-6 font-weight-bolder" for="nom">Mot de passe actuel
                                            :</label>
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" id="oldpass" name="Password"
                                                style="border-left: 0.25rem solid #3453af !important" autocomplete="off"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-6 font-weight-bolder" for="nom">Nouveau mot de passe
                                            :</label>
                                        <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-6 font-weight-bolder" for="nom">Confirmer le mot de passe
                                            :</label>
                                        <div class="col-md-9">
                                            <input id="confpass" name="ConfirmedPassword" type="password"
                                                class="form-control"
                                                style="border-left: 0.25rem solid #3453af !important" autocomplete="off"
                                                required />
                                        </div>
                                ...
                                <div class="row mt-5 justify-content-center">
                                    <button class="btn btn" type="submit" onClick="validation()" name="valider"
                                        id="valider" style="background-color: #3453af; color: white">
